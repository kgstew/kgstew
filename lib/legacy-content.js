/**
 * TEMPORARY — the pre-migration content reader.
 *
 * `lib/content/` is the real model (validated, disclosure-enforced, frozen) but
 * it reads `content/work/` and `content/writing/`, which do not exist until the
 * content migration. Until then the pages stay on this reader.
 *
 * Deleted by the migration ticket. Do not add anything to it.
 */
